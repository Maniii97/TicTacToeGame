...
public class MainActivity extends AppCompatActivity {
    ...
    private void changePlayerTurn(int currentPlayerTurn) {
        ...
        if (playerTurn == 1) {
            binding.playerOneLayout.setBackgroundResource(R.drawable.blaborder);
            binding.playerTwoLayout.setBackgroundResource(R.drawable.whitebox);
        } else {
            binding.playerTwoLayout.setBackgroundResource(R.drawable.blaborder);
            binding.playerOneLayout.setBackgroundResource(R.drawable.whitebox);
        }
    }
